...
| Datové struktury      | ` 08-hodina-zaklady-csharp`                | 2025-10-17        | 2025-10-17      | Používání datových struktur (array, dictionary, list, ...) + Moodle test, Samostatná práce č.3 (matice)  |
| Datové struktury      | ` 09-hodina-zaklady-csharp`                | 2025-10-24        | 2025-10-21      | Samostatná práce č.3 (matice) |
| -      | ` -`                | -        | -      | - |  - |
| -      | ` -`                | -        | -      | - |  - |
| -      | ` -`                | -        | -      | - |  - |
| -      | ` -`                | -        | -      | - |  - |
